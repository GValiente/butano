...
ifeq ($(SYSTEM),)
$(error "Please specify SYSTEM, valid systems are: GBA, DS7, DS9, DS9E" )
endif
...
SOURCES		:=	source source_ds7 source_ds9 source_ds9e source_ds
BUILD		:=	build_ds9e
TARGET		:=	$(TOPDIR)/lib/libmm9e.a
include $(DEVKITARM)/ds_rules
GOODSYSTEM	:= YES
...
DEFS	:=	-DSYS_NDS -DSYS_NDS9 -DSYS_NDS9E
ARCH	:=	-mthumb-interwork -march=armv5te -mtune=arm946e-s
