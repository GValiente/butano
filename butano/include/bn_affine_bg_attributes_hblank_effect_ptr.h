...
#ifndef BN_AFFINE_BG_ATTRIBUTES_HBLANK_EFFECT_PTR_H
#define BN_AFFINE_BG_ATTRIBUTES_HBLANK_EFFECT_PTR_H

/**
 * @file
 * bn::affine_bg_attributes_hblank_effect_ptr header file.
 *
 * @ingroup affine_bg
 ...
 * @ingroup hblank_effect
 */
class affine_bg_attributes_hblank_effect_ptr : public hblank_effect_ptr
{

public:
    /**
     * @brief Creates an affine_bg_attributes_hblank_effect_ptr which changes the attributes to commit
     ...
     *
     * @return The requested affine_bg_attributes_hblank_effect_ptr.
     */
    [[nodiscard]] static affine_bg_attributes_hblank_effect_ptr create(
    ...
    /**
     * @brief Exchanges the contents of this affine_bg_attributes_hblank_effect_ptr with those of the other one.
     * @param other affine_bg_attributes_hblank_effect_ptr to exchange the contents with.
     */
    void swap(affine_bg_attributes_hblank_effect_ptr& other);

    /**
     * @brief Exchanges the contents of an affine_bg_attributes_hblank_effect_ptr with those of another one.
     * @param a First affine_bg_attributes_hblank_effect_ptr to exchange the contents with.
     * @param b Second affine_bg_attributes_hblank_effect_ptr to exchange the contents with.
     */
    friend void swap(affine_bg_attributes_hblank_effect_ptr& a, affine_bg_attributes_hblank_effect_ptr& b)
    {
        a.swap(b);
    }
...
private:
    ...
    affine_bg_attributes_hblank_effect_ptr(int id, affine_bg_ptr&& bg);
};
