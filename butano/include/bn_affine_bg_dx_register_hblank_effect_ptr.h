 ...
 * @ingroup hblank_effect
 */
class affine_bg_dx_register_hblank_effect_ptr : public hblank_effect_ptr
{
...
public:
    ...
    /**
     * @brief Exchanges the contents of this affine_bg_dx_register_hblank_effect_ptr
    ...
    /**
     * @brief Exchanges the contents of an affine_bg_dx_register_hblank_effect_ptr
...
private:
    ...
    affine_bg_dx_register_hblank_effect_ptr(int id, bool from_attributes, affine_bg_ptr&& bg);
};
