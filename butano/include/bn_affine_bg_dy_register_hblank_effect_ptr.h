...
#ifndef BN_AFFINE_BG_DY_REGISTER_HBLANK_EFFECT_PTR_H
#define BN_AFFINE_BG_DY_REGISTER_HBLANK_EFFECT_PTR_H

/**
 * @file
 * bn::affine_bg_dy_register_hblank_effect_ptr header file.
 *
 * @ingroup affine_bg
...
public:
     ...
     *
     * @return The requested affine_bg_dy_register_hblank_effect_ptr.
     */
    [[nodiscard]] static affine_bg_dy_register_hblank_effect_ptr create(
     ...
     * affine_bg_dy_register_hblank_effect_ptr to avoid dangling references.
     *
     * @return The requested affine_bg_dy_register_hblank_effect_ptr if it could be allocated;
     * `nullopt` otherwise.
     */
    [[nodiscard]] static optional<affine_bg_dy_register_hblank_effect_ptr> create_optional(
            affine_bg_ptr bg, const span<const affine_bg_mat_attributes>& attributes_ref);
     ...
     */
    friend void swap(affine_bg_dy_register_hblank_effect_ptr& a,
                     affine_bg_dy_register_hblank_effect_ptr& b)
    {
        a.swap(b);
    }
