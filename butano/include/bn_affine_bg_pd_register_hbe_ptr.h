...
#ifndef BN_AFFINE_BG_PD_REGISTER_HBE_PTR_H
#define BN_AFFINE_BG_PD_REGISTER_HBE_PTR_H
 ...
 * @ingroup hblank_effect
 */
class affine_bg_pd_register_hbe_ptr : public hbe_ptr
{

public:
    /**
     * @brief Creates an affine_bg_pd_register_hbe_ptr which changes the attributes to commit
     ...
     */
    [[nodiscard]] static affine_bg_pd_register_hbe_ptr create(
            affine_bg_ptr bg, const span<const affine_bg_mat_attributes>& attributes_ref);

    /**
     * @brief Creates an affine_bg_pd_register_hbe_ptr which changes the values to commit
     * to the fourth GBA register of an affine_bg_ptr.
     * @param bg affine_bg_ptr to be modified.
     ...
     */
    [[nodiscard]] static optional<affine_bg_pd_register_hbe_ptr> create_optional(
            affine_bg_ptr bg, const span<const affine_bg_mat_attributes>& attributes_ref);
    ...
    /**
     * @brief Exchanges the contents of this affine_bg_pd_register_hbe_ptr with those of the other one.
     * @param other affine_bg_pd_register_hbe_ptr to exchange the contents with.
     */
    void swap(affine_bg_pd_register_hbe_ptr& other);

    /**
     * @brief Exchanges the contents of an affine_bg_pd_register_hbe_ptr with those of another one.
     * @param a First affine_bg_pd_register_hbe_ptr to exchange the contents with.
     * @param b Second affine_bg_pd_register_hbe_ptr to exchange the contents with.
     */
    friend void swap(affine_bg_pd_register_hbe_ptr& a, affine_bg_pd_register_hbe_ptr& b)
    {
        a.swap(b);
    }
...
private:
    ...
    affine_bg_pd_register_hbe_ptr(int id, bool from_attributes, affine_bg_ptr&& bg);
};
