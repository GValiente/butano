...
#ifndef BN_AFFINE_BG_PIVOT_POSITION_HBE_PTR_H
#define BN_AFFINE_BG_PIVOT_POSITION_HBE_PTR_H

/**
 * @file
 * bn::affine_bg_pivot_position_hbe_ptr header file.
 *
 * @ingroup affine_bg
 ...
 * @ingroup hblank_effect
 */
class affine_bg_pivot_position_hbe_ptr : public hbe_ptr
{

public:
    /**
     * @brief Creates an affine_bg_pivot_position_hbe_ptr which changes
     ...
     * so they should outlive the affine_bg_pivot_position_hbe_ptr to avoid dangling references.
     *
     * @return The requested affine_bg_pivot_position_hbe_ptr.
     */
    [[nodiscard]] static affine_bg_pivot_position_hbe_ptr create_horizontal(
     ...
     * @return The requested affine_bg_pivot_position_hbe_ptr.
     */
    [[nodiscard]] static affine_bg_pivot_position_hbe_ptr create_vertical(
            affine_bg_ptr bg, const span<const fixed>& deltas_ref);
     ...
     * so they should outlive the affine_bg_pivot_position_hbe_ptr to avoid dangling references.
     *
     * @return The requested affine_bg_pivot_position_hbe_ptr if it could be allocated; bn::nullopt otherwise.
     */
    [[nodiscard]] static optional<affine_bg_pivot_position_hbe_ptr> create_horizontal_optional(
            affine_bg_ptr bg, const span<const fixed>& deltas_ref);
     ...
     * @return The requested affine_bg_pivot_position_hbe_ptr if it could be allocated; bn::nullopt otherwise.
     */
    [[nodiscard]] static optional<affine_bg_pivot_position_hbe_ptr> create_vertical_optional(
            affine_bg_ptr bg, const span<const fixed>& deltas_ref);
    ...
    /**
     * @brief Exchanges the contents of this affine_bg_pivot_position_hbe_ptr with those of the other one.
     * @param other affine_bg_pivot_position_hbe_ptr to exchange the contents with.
     */
    void swap(affine_bg_pivot_position_hbe_ptr& other);

    /**
     * @brief Exchanges the contents of an affine_bg_pivot_position_hbe_ptr with those of another one.
     * @param a First affine_bg_pivot_position_hbe_ptr to exchange the contents with.
     * @param b Second affine_bg_pivot_position_hbe_ptr to exchange the contents with.
     */
    friend void swap(affine_bg_pivot_position_hbe_ptr& a, affine_bg_pivot_position_hbe_ptr& b)
    {
        a.swap(b);
    }
...
private:
    ...
    affine_bg_pivot_position_hbe_ptr(int id, affine_bg_ptr&& bg);
};
