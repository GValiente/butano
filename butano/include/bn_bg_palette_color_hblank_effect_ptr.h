...
#ifndef BN_BG_PALETTE_COLOR_HBLANK_EFFECT_PTR_H
#define BN_BG_PALETTE_COLOR_HBLANK_EFFECT_PTR_H

/**
 * @file
 * bn::bg_palette_color_hblank_effect_ptr header file.
 *
 * @ingroup bg
 * @ingroup palette
...
public:
     ...
     * to avoid dangling references.
     *
     * @return The requested bg_palette_color_hblank_effect_ptr if it could be allocated; bn::nullopt otherwise.
     */
