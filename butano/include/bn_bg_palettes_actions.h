...
/**
 * @brief Manages the intensity of the hue shift effect applied to all background color palettes.
 *
 * @ingroup bg
 * @ingroup palette
 * @ingroup action
...
public:
    ...
    [[nodiscard]] static fixed get()
    {
        return bg_palettes::hue_shift_intensity();
    }
    ...
    static void set(fixed intensity)
    {
        bg_palettes::set_hue_shift_intensity(intensity);
    }
};


/**
 * @brief Modifies the intensity of the hue shift effect applied to all background color palettes
 * until it has a given state.
 *
 * @ingroup bg
 * @ingroup palette
 * @ingroup action
 */
class bg_palettes_hue_shift_to_action : public to_template_action<fixed, bg_palettes_hue_shift_manager>
{
...
public:
     ...
     * This intensity must be in the range [0..1].
     */
    bg_palettes_hue_shift_to_action(int duration_updates, fixed final_intensity) :
        to_template_action(duration_updates, final_intensity)
    {
        BN_ASSERT(final_intensity >= 0 && final_intensity <= 1, "Invalid final intensity: ", final_intensity);
    }
 ...
 * @ingroup action
 */
class bg_palettes_hue_shift_loop_action : public loop_template_action<fixed, bg_palettes_hue_shift_manager>
{
...
public:
     ...
     * This intensity must be in the range [0..1].
     */
    bg_palettes_hue_shift_loop_action(int duration_updates, fixed final_intensity) :
        loop_template_action(duration_updates, final_intensity)
    {
        BN_ASSERT(final_intensity >= 0 && final_intensity <= 1, "Invalid final intensity: ", final_intensity);
    }
...
/**
 * @brief Changes the intensity of the hue shift effect applied to all background color palettes
 * when the action is updated a given number of times.
 *
 * @ingroup bg
 * @ingroup palette
 * @ingroup action
 */
class bg_palettes_hue_shift_toggle_action : public toggle_template_action<fixed, bg_palettes_hue_shift_manager>
{
...
public:
     ...
     * This intensity must be in the range [0..1].
     */
    bg_palettes_hue_shift_toggle_action(int duration_updates, fixed new_intensity) :
        toggle_template_action(duration_updates, new_intensity)
    {
        BN_ASSERT(new_intensity >= 0 && new_intensity <= 1, "Invalid new intensity: ", new_intensity);
    }
