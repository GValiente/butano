...
#ifndef BN_BLENDING_FADE_ALPHA_HBLANK_EFFECT_PTR_H
#define BN_BLENDING_FADE_ALPHA_HBLANK_EFFECT_PTR_H

/**
 * @file
 * bn::blending_fade_alpha_hblank_effect_ptr header file.
 *
 * @ingroup blending
