...
public:
     ...
     * so it should be faster than dp_direct_bitmap_bg_painter::unsafe_draw.
     * @param x Horizontal position of the current page top-left corner [0..bitmap_bg::dp_direct_width()).
     * @param y Vertical position of the current page top-left corner [0..bitmap_bg::dp_direct_height()).
    ...
    /**
     * @brief Copies the given item to the current page without bounds checking. Transparent pixels are also ,
     * so it should be faster than dp_direct_bitmap_bg_painter::unsafe_draw.
     ...
     * Transparent pixels are also copied, so it should be faster than dp_direct_bitmap_bg_painter::unsafe_draw.
     * @param x Horizontal position of the current page top-left corner [0..bitmap_bg::dp_direct_width()).
     * @param y Vertical position of the current page top-left corner [0..bitmap_bg::dp_direct_height()).
     ...
     * so it should be faster than dp_direct_bitmap_bg_painter::draw.
     * @param x Horizontal position of the current page top-left corner [0..bitmap_bg::dp_direct_width()).
     * @param y Vertical position of the current page top-left corner [0..bitmap_bg::dp_direct_height()).
     * @param item Item to copy to the current page.
     */
     ...
     * Transparent pixels are also copied, so it should be faster than dp_direct_bitmap_bg_painter::draw.
     * @param x Horizontal position of the current page top-left corner [0..bitmap_bg::dp_direct_width()).
     * @param y Vertical position of the current page top-left corner [0..bitmap_bg::dp_direct_height()).
     * @param roi Region of interest to copy to the current page.
     */
     ...
     * so it should be slower than dp_direct_bitmap_bg_painter::unsafe_blit.
     * @param x Horizontal position of the current page top-left corner [0..bitmap_bg::dp_direct_width()).
     * @param y Vertical position of the current page top-left corner [0..bitmap_bg::dp_direct_height()).
     * @param item Item to copy to the current page.
    ...
    /**
     * @brief Copies the given region of interest to the current page without bounds checking.
     * Transparent pixels are skipped, so it should be slower than dp_direct_bitmap_bg_painter::unsafe_blit.
     * @param x Horizontal position of the current page top-left corner [0..bitmap_bg::dp_direct_width()).
     * @param y Vertical position of the current page top-left corner [0..bitmap_bg::dp_direct_height()).
     * @param roi Region of interest to copy to the current page.
     * @param transparent_color Color of the transparent pixels.
     ...
     * so it should be slower than dp_direct_bitmap_bg_painter::blit.
     * @param x Horizontal position of the current page top-left corner [0..bitmap_bg::dp_direct_width()).
     * @param y Vertical position of the current page top-left corner [0..bitmap_bg::dp_direct_height()).
     * @param item Item to copy to the current page.
     * @param transparent_color Color of the transparent pixels.
    ...
    /**
     * @brief Copies the given region of interest to the current page with bounds checking.
     * Transparent pixels are skipped, so it should be slower than dp_direct_bitmap_bg_painter::blit.
     * @param x Horizontal position of the current page top-left corner [0..bitmap_bg::dp_direct_width()).
     * @param y Vertical position of the current page top-left corner [0..bitmap_bg::dp_direct_height()).
     * @param roi Region of interest to copy to the current page.
     * @param transparent_color Color of the transparent pixels.
