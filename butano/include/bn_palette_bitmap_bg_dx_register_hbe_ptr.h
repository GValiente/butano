...
#ifndef BN_PALETTE_BITMAP_BG_DX_REGISTER_HBE_PTR_H
#define BN_PALETTE_BITMAP_BG_DX_REGISTER_HBE_PTR_H

/**
 * @file
 * bn::palette_bitmap_bg_dx_register_hbe_ptr header file.
 *
 ...
 * the attributes or the values to commit to the the fifth GBA register of a palette_bitmap_bg_ptr
 * in each screen horizontal line.
 *
 * @ingroup palette_bitmap_bg
 * @ingroup hblank_effect
 */
class palette_bitmap_bg_dx_register_hbe_ptr : public hbe_ptr
{

public:
    /**
     * @brief Creates a palette_bitmap_bg_dx_register_hbe_ptr which changes the attributes to commit
     * to the the fifth GBA register of a palette_bitmap_bg_ptr.
     ...
     * with the attributes to commit to the the fifth GBA register of a palette_bitmap_bg_ptr
     * in each screen horizontal line.
     *
     ...
     */
    [[nodiscard]] static palette_bitmap_bg_dx_register_hbe_ptr create(
            palette_bitmap_bg_ptr bg, const span<const affine_bg_mat_attributes>& attributes_ref);

    /**
     * @brief Creates a palette_bitmap_bg_dx_register_hbe_ptr which changes the values to commit
     * to the the fifth GBA register of a palette_bitmap_bg_ptr.
     * @param bg palette_bitmap_bg_ptr to be modified.
     ...
     */
    [[nodiscard]] static optional<palette_bitmap_bg_dx_register_hbe_ptr> create_optional(
            palette_bitmap_bg_ptr bg, const span<const affine_bg_mat_attributes>& attributes_ref);
    ...
    /**
     * @brief Exchanges the contents of this palette_bitmap_bg_dx_register_hbe_ptr with those of the other one.
     * @param other palette_bitmap_bg_dx_register_hbe_ptr to exchange the contents with.
     */
    void swap(palette_bitmap_bg_dx_register_hbe_ptr& other);

    /**
     * @brief Exchanges the contents of a palette_bitmap_bg_dx_register_hbe_ptr with those of another one.
     * @param a First palette_bitmap_bg_dx_register_hbe_ptr to exchange the contents with.
     * @param b Second palette_bitmap_bg_dx_register_hbe_ptr to exchange the contents with.
     */
    friend void swap(palette_bitmap_bg_dx_register_hbe_ptr& a, palette_bitmap_bg_dx_register_hbe_ptr& b)
    {
        a.swap(b);
    }
...
private:
    ...
    palette_bitmap_bg_dx_register_hbe_ptr(int id, bool from_attributes, palette_bitmap_bg_ptr&& bg);
};
