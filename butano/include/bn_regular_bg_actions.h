...
/**
 * @brief Manages the top-left position of a regular_bg_ptr.
 *
 * @ingroup regular_bg
 * @ingroup action
 */
class regular_bg_top_left_position_manager
{

public:
    /**
     * @brief Returns the top-left position of the given regular_bg_ptr.
     */
    [[nodiscard]] static fixed_point get(const regular_bg_ptr& bg)
    {
        return bg.top_left_position();
    }

    /**
     * @brief Sets the top-left position of the given regular_bg_ptr.
     */
...
/**
 * @brief Modifies the top-left position of a regular_bg_ptr until it has a given state.
 *
 * @ingroup regular_bg
 * @ingroup action
 */
class regular_bg_top_left_move_to_action :
        public to_value_template_action<regular_bg_ptr, fixed_point, regular_bg_top_left_position_manager>
{
...
public:
     ...
     * @param bg regular_bg_ptr to copy.
     * @param duration_updates Number of times that the action must be updated
     * until the top-left position of the given regular_bg_ptr is equal to (final_x, final_y).
     * @param final_top_left_x Horizontal top-left position of the given regular_bg_ptr
     * when the action is updated duration_updates times.
     * @param final_top_left_y Vertical top-left position of the given regular_bg_ptr
     * when the action is updated duration_updates times.
     */
    regular_bg_top_left_move_to_action(
            const regular_bg_ptr& bg, int duration_updates, fixed final_top_left_x, fixed final_top_left_y) :
     ...
     */
    regular_bg_top_left_move_to_action(
            regular_bg_ptr&& bg, int duration_updates, fixed final_top_left_x, fixed final_top_left_y) :
     ...
     * @param bg regular_bg_ptr to copy.
     * @param duration_updates Number of times that the action must be updated
     * until the top-left position of the given regular_bg_ptr is equal to final_top_left_position.
     * @param final_top_left_position Top-left position of the given regular_bg_ptr
     * when the action is updated duration_updates times.
     */
    regular_bg_top_left_move_to_action(
            const regular_bg_ptr& bg, int duration_updates, const fixed_point& final_top_left_position) :
     ...
     */
    regular_bg_top_left_move_to_action(
            regular_bg_ptr&& bg, int duration_updates, const fixed_point& final_top_left_position) :
...
/**
 * @brief Modifies the top-left position of a regular_bg_ptr from a minimum to a maximum.
...
class regular_bg_top_left_move_loop_action :
        public loop_value_template_action<regular_bg_ptr, fixed_point, regular_bg_top_left_position_manager>
{
...
public:
     ...
     * @param final_top_left_y When the vertical top-left position of the given regular_bg_ptr
     * is equal to this parameter, it goes back to its initial state and vice versa.
     */
    regular_bg_top_left_move_loop_action(
            const regular_bg_ptr& bg, int duration_updates, fixed final_top_left_x, fixed final_top_left_y) :
    ...
    /**
     * @brief When the top-left position of the given regular_bg_ptr is equal to this returned parameter,
     * it goes back to its initial state and vice versa.
     */
    [[nodiscard]] const fixed_point& final_top_left_position() const
    {
...
/**
 * @brief Changes the top-left position of a regular_bg_ptr when the action is updated a given number of times.
 *
 * @ingroup regular_bg
 * @ingroup action
 */
class regular_bg_top_left_move_toggle_action :
        public toggle_value_template_action<regular_bg_ptr, fixed_point, regular_bg_top_left_position_manager>
{
...
public:
     ...
     */
    regular_bg_top_left_move_toggle_action(
            const regular_bg_ptr& bg, int duration_updates, fixed new_top_left_x, fixed new_top_left_y) :
     ...
     */
    regular_bg_top_left_move_toggle_action(
            regular_bg_ptr&& bg, int duration_updates, fixed new_top_left_x, fixed new_top_left_y) :
     ...
     */
    regular_bg_top_left_move_toggle_action(
            const regular_bg_ptr& bg, int duration_updates, const fixed_point& new_top_left_position) :
     ...
     */
    regular_bg_top_left_move_toggle_action(
            regular_bg_ptr&& bg, int duration_updates, const fixed_point& new_top_left_position) :
