...
#ifndef BN_REGULAR_BG_POSITION_HBLANK_EFFECT_PTR_H
#define BN_REGULAR_BG_POSITION_HBLANK_EFFECT_PTR_H

/**
 * @file
 * bn::regular_bg_position_hblank_effect_ptr header file.
 *
 * @ingroup regular_bg
