...
#ifndef BN_SP_DIRECT_BITMAP_BG_PTR_H
#define BN_SP_DIRECT_BITMAP_BG_PTR_H

/**
 * @file
 * bn::sp_direct_bitmap_bg_ptr header file.
 *
...
/**
 * @brief std::shared_ptr like smart pointer that retains shared ownership of a single page direct bitmap background.
 *
 * Several sp_direct_bitmap_bg_ptr objects may own the same background.
 *
 * The background is released when the last remaining sp_direct_bitmap_bg_ptr owning it is destroyed.
 *
 * @ingroup sp_direct_bitmap_bg
 */
...
public:
    ...
    /**
     * @brief Creates a sp_direct_bitmap_bg_ptr.
     */
    [[nodiscard]] static sp_direct_bitmap_bg_ptr create();

    /**
     * @brief Creates a sp_direct_bitmap_bg_ptr from a sp_direct_bitmap_bg_builder reference.
     * @param builder sp_direct_bitmap_bg_builder reference.
     * @return The requested sp_direct_bitmap_bg_ptr.
     */
    [[nodiscard]] static sp_direct_bitmap_bg_ptr create(const sp_direct_bitmap_bg_builder& builder);

    /**
     * @brief Creates a sp_direct_bitmap_bg_ptr from a moved sp_direct_bitmap_bg_builder.
     * @param builder sp_direct_bitmap_bg_builder to move.
     * @return The requested sp_direct_bitmap_bg_ptr.
     */
    [[nodiscard]] static sp_direct_bitmap_bg_ptr create(sp_direct_bitmap_bg_builder&& builder);

    /**
     * @brief Creates a sp_direct_bitmap_bg_ptr from a sp_direct_bitmap_bg_builder reference.
     */
    [[nodiscard]] static optional<sp_direct_bitmap_bg_ptr> create_optional();

    /**
     * @brief Creates a sp_direct_bitmap_bg_ptr from a sp_direct_bitmap_bg_builder reference.
     * @param builder sp_direct_bitmap_bg_builder reference.
     * @return The requested sp_direct_bitmap_bg_ptr if it could be allocated; bn::nullopt otherwise.
     */
    [[nodiscard]] static optional<sp_direct_bitmap_bg_ptr> create_optional(const sp_direct_bitmap_bg_builder& builder);
     ...
     * @return The requested sp_direct_bitmap_bg_ptr if it could be allocated; bn::nullopt otherwise.
     */
    [[nodiscard]] static optional<sp_direct_bitmap_bg_ptr> create_optional(sp_direct_bitmap_bg_builder&& builder);

    /**
     * @brief Copy constructor.
     * @param other sp_direct_bitmap_bg_ptr to copy.
     */
    sp_direct_bitmap_bg_ptr(const sp_direct_bitmap_bg_ptr& other);
     ...
     */
    sp_direct_bitmap_bg_ptr& operator=(const sp_direct_bitmap_bg_ptr& other);

    /**
     * @brief Move constructor.
     * @param other sp_direct_bitmap_bg_ptr to move.
     */
    sp_direct_bitmap_bg_ptr(sp_direct_bitmap_bg_ptr&& other) noexcept :
     ...
     * @return Reference to this.
     */
    sp_direct_bitmap_bg_ptr& operator=(sp_direct_bitmap_bg_ptr&& other) noexcept
    {
    ...
    /**
     * @brief Releases the referenced background if no more sp_direct_bitmap_bg_ptr objects reference to it.
     */
    ~sp_direct_bitmap_bg_ptr();
    ...
    /**
     * @brief Exchanges the contents of this sp_direct_bitmap_bg_ptr with those of the other one.
     * @param other sp_direct_bitmap_bg_ptr to exchange the contents with.
     */
    void swap(sp_direct_bitmap_bg_ptr& other)
    {
        bn::swap(_handle, other._handle);
    }

    /**
     * @brief Exchanges the contents of an sp_direct_bitmap_bg_ptr with those of another one.
     * @param a First sp_direct_bitmap_bg_ptr to exchange the contents with.
     * @param b Second sp_direct_bitmap_bg_ptr to exchange the contents with.
     */
    friend void swap(sp_direct_bitmap_bg_ptr& a, sp_direct_bitmap_bg_ptr& b)
    {
     ...
     */
    [[nodiscard]] friend bool operator==(const sp_direct_bitmap_bg_ptr& a, const sp_direct_bitmap_bg_ptr& b) = default;
...
private:
    ...
    explicit sp_direct_bitmap_bg_ptr(handle_type handle) :
        _handle(handle)
    {
    }
};
...
/**
 * @brief Hash support for sp_direct_bitmap_bg_ptr.
 *
 * @ingroup sp_direct_bitmap_bg
 * @ingroup functional
 */
template<>
struct hash<sp_direct_bitmap_bg_ptr>
{
    /**
     * @brief Returns the hash of the given sp_direct_bitmap_bg_ptr.
     */
    [[nodiscard]] unsigned operator()(const sp_direct_bitmap_bg_ptr& value) const
    {
