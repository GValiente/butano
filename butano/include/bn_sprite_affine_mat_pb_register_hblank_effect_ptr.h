...
#ifndef BN_SPRITE_AFFINE_MAT_PB_REGISTER_HBLANK_EFFECT_PTR_H
#define BN_SPRITE_AFFINE_MAT_PB_REGISTER_HBLANK_EFFECT_PTR_H

/**
 * @file
 * bn::sprite_affine_mat_pb_register_hblank_effect_ptr header file.
 *
 * @ingroup sprite
 * @ingroup affine_mat
...
public:
    /**
     * @brief Creates a sprite_affine_mat_pb_register_hblank_effect_ptr which changes the attributes to commit
     ...
     *
     * @return The requested sprite_affine_mat_pb_register_hblank_effect_ptr.
     */
    ...
    /**
     * @brief Creates a sprite_affine_mat_pb_register_hblank_effect_ptr which changes the values to commit
     * to the second GBA register of a sprite_affine_mat_ptr.
     * @param affine_mat sprite_affine_mat_ptr to be modified.
    ...
    /**
     * @brief Exchanges the contents of this sprite_affine_mat_pb_register_hblank_effect_ptr
     * with those of the other one.
     * @param other sprite_affine_mat_pb_register_hblank_effect_ptr to exchange the contents with.
     */
    void swap(sprite_affine_mat_pb_register_hblank_effect_ptr& other);

    /**
     * @brief Exchanges the contents of a sprite_affine_mat_pb_register_hblank_effect_ptr
     * with those of another one.
     * @param a First sprite_affine_mat_pb_register_hblank_effect_ptr to exchange the contents with.
     * @param b Second sprite_affine_mat_pb_register_hblank_effect_ptr to exchange the contents with.
     */
