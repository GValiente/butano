...
#ifndef BN_SPRITE_AFFINE_MAT_PC_REGISTER_HBE_PTR_H
#define BN_SPRITE_AFFINE_MAT_PC_REGISTER_HBE_PTR_H

/**
 * @file
 * bn::sprite_affine_mat_pc_register_hbe_ptr header file.
 *
 * @ingroup sprite
 * @ingroup affine_mat
 ...
 * @ingroup hblank_effect
 */
class sprite_affine_mat_pc_register_hbe_ptr : public hbe_ptr
{

public:
    /**
     * @brief Creates a sprite_affine_mat_pc_register_hbe_ptr which changes the attributes to commit
     ...
     * the sprite_affine_mat_pc_register_hbe_ptr to avoid dangling references.
     *
     * @return The requested sprite_affine_mat_pc_register_hbe_ptr.
     */
    [[nodiscard]] static sprite_affine_mat_pc_register_hbe_ptr create(
            sprite_affine_mat_ptr affine_mat, const span<const affine_mat_attributes>& attributes_ref);

    /**
     * @brief Creates a sprite_affine_mat_pc_register_hbe_ptr which changes the values to commit
     * to the third GBA register of a sprite_affine_mat_ptr.
     * @param affine_mat sprite_affine_mat_ptr to be modified.
     ...
     * the sprite_affine_mat_pc_register_hbe_ptr to avoid dangling references.
     *
     * @return The requested sprite_affine_mat_pc_register_hbe_ptr if it could be allocated;
     * bn::nullopt otherwise.
     */
    [[nodiscard]] static optional<sprite_affine_mat_pc_register_hbe_ptr> create_optional(
            sprite_affine_mat_ptr affine_mat, const span<const affine_mat_attributes>& attributes_ref);
    ...
    /**
     * @brief Exchanges the contents of this sprite_affine_mat_pc_register_hbe_ptr with those of the other one.
     * @param other sprite_affine_mat_pc_register_hbe_ptr to exchange the contents with.
     */
    void swap(sprite_affine_mat_pc_register_hbe_ptr& other);

    /**
     * @brief Exchanges the contents of a sprite_affine_mat_pc_register_hbe_ptr with those of another one.
     * @param a First sprite_affine_mat_pc_register_hbe_ptr to exchange the contents with.
     * @param b Second sprite_affine_mat_pc_register_hbe_ptr to exchange the contents with.
     */
    friend void swap(sprite_affine_mat_pc_register_hbe_ptr& a, sprite_affine_mat_pc_register_hbe_ptr& b)
    {
        a.swap(b);
    }
...
private:
    ...
    sprite_affine_mat_pc_register_hbe_ptr(int id, bool from_attributes, sprite_affine_mat_ptr&& affine_mat);
};
