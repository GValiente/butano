...
#ifndef BN_SPRITE_AFFINE_MAT_PC_REGISTER_HBLANK_EFFECT_PTR_H
#define BN_SPRITE_AFFINE_MAT_PC_REGISTER_HBLANK_EFFECT_PTR_H

/**
 * @file
 * bn::sprite_affine_mat_pc_register_hblank_effect_ptr header file.
 *
 * @ingroup sprite
 * @ingroup affine_mat
...
public:
     ...
     * sprite_affine_mat_pc_register_hblank_effect_ptr to avoid dangling references.
     *
     * @return The requested sprite_affine_mat_pc_register_hblank_effect_ptr if it could be allocated;
