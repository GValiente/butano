...
#ifndef BN_SPRITE_AFFINE_SECOND_ATTRIBUTES_HBLANK_EFFECT_PTR_H
#define BN_SPRITE_AFFINE_SECOND_ATTRIBUTES_HBLANK_EFFECT_PTR_H

/**
 * @file
 * bn::sprite_affine_second_attributes_hblank_effect_ptr header file.
 *
 * @ingroup sprite
