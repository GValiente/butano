...
#ifndef BN_SPRITE_POSITION_HBLANK_EFFECT_PTR_H
#define BN_SPRITE_POSITION_HBLANK_EFFECT_PTR_H

/**
 * @file
 * bn::sprite_position_hblank_effect_ptr header file.
 *
 * @ingroup sprite
...
/**
 * @brief std::shared_ptr like smart pointer that retains shared ownership of a H-Blank effect which changes the position of a sprite
...
public:
     ...
     * to avoid dangling references.
     *
     * @return The requested sprite_position_hblank_effect_ptr if it could be allocated; bn::nullopt otherwise.
     */
