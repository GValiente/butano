...
#ifndef BN_SPRITE_THIRD_ATTRIBUTES_HBLANK_EFFECT_PTR_H
#define BN_SPRITE_THIRD_ATTRIBUTES_HBLANK_EFFECT_PTR_H

/**
 * @file
 * bn::sprite_third_attributes_hblank_effect_ptr header file.
 *
 * @ingroup sprite
