...
public:
    ...
    [[nodiscard]] static optional<bg_palette_ptr> create_optional(const span<const color>& colors_ref,
                                                                  palette_bpp_mode bpp_mode);

    [[nodiscard]] static optional<bg_palette_ptr> find_or_create_optional(const span<const color>& colors_ref,
                                                                          palette_bpp_mode bpp_mode);
