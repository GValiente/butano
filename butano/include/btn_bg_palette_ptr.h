...
public:
     ...
     * @return bg_palette_ptr which contains the given colors if it has been found; <b>nullopt</b> otherwise.
     */
     ...
     * @param colors Colors of the palette to search or create.
     * @param bpp_mode Bits per pixel of the palette to search or create.
     * @return The requested bg_palette_ptr if it could be allocated; <b>nullopt</b> otherwise.
     */
