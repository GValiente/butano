...
public:
    ...
    /**
     * @brief Release the referenced map cells if no more regular_bg_map_ptr objects reference to them.
     */
    ~regular_bg_map_ptr()
    {
        if(_handle >= 0)
     ...
     * if this regular_bg_map_cell was created with allocate or allocate_optional; <b>nullopt</b> otherwise.
     */
