...
#ifndef BTN_SPRITE_AFFINE_MAT_PA_REGISTER_HBLANK_EFFECT_PTR_H
#define BTN_SPRITE_AFFINE_MAT_PA_REGISTER_HBLANK_EFFECT_PTR_H
 ...
 * the attributes or the values to commit to the first GBA register of a sprite_affine_mat_ptr
 ...
 */
class sprite_affine_mat_pa_register_hblank_effect_ptr : public hblank_effect_ptr
{

public:
    /**
     * @brief Creates a sprite_affine_mat_pa_register_hblank_effect_ptr which changes the attributes to commit
     * to the first GBA register of a sprite_affine_mat_ptr.
     ...
     * with the attributes to commit to the first GBA register of a sprite_affine_mat_ptr
     * in each screen horizontal line.
     *
     ...
     *
     * @return The requested sprite_affine_mat_pa_register_hblank_effect_ptr.
     */
    [[nodiscard]] static sprite_affine_mat_pa_register_hblank_effect_ptr create(
            sprite_affine_mat_ptr affine_mat, const span<const sprite_affine_mat_attributes>& attributes_ref);

    /**
     * @brief Creates a sprite_affine_mat_pa_register_hblank_effect_ptr which changes the values to commit
     * to the first GBA register of a sprite_affine_mat_ptr.
     * @param affine_mat sprite_affine_mat_ptr to be modified.
     ...
     * sprite_affine_mat_pa_register_hblank_effect_ptr to avoid dangling references.
     *
     * @return The requested sprite_affine_mat_pa_register_hblank_effect_ptr if it can be allocated;
    ...
    /**
     * @brief Exchanges the contents of this sprite_affine_mat_pa_register_hblank_effect_ptr
     * with those of the other one.
     * @param other sprite_affine_mat_pa_register_hblank_effect_ptr to exchange the contents with.
     */
    void swap(sprite_affine_mat_pa_register_hblank_effect_ptr& other);

    /**
     * @brief Exchanges the contents of a sprite_affine_mat_pa_register_hblank_effect_ptr
     * with those of another one.
     * @param a First sprite_affine_mat_pa_register_hblank_effect_ptr to exchange the contents with.
     * @param b Second sprite_affine_mat_pa_register_hblank_effect_ptr to exchange the contents with.
     */
    friend void swap(sprite_affine_mat_pa_register_hblank_effect_ptr& a,
                     sprite_affine_mat_pa_register_hblank_effect_ptr& b)
    {
        a.swap(b);
    }
...
private:
    ...
    sprite_affine_mat_pa_register_hblank_effect_ptr(int id, bool from_attributes, sprite_affine_mat_ptr&& affine_mat);
};
