...
#ifndef BTN_SPRITE_AFFINE_MAT_PD_REGISTER_HBLANK_EFFECT_PTR_H
#define BTN_SPRITE_AFFINE_MAT_PD_REGISTER_HBLANK_EFFECT_PTR_H

/**
 * @file
 * btn::sprite_affine_mat_pd_register_hblank_effect_ptr header file.
 *
 * @ingroup sprite
 * @ingroup affine_mat
 ...
 * @ingroup hblank_effect
 */
class sprite_affine_mat_pd_register_hblank_effect_ptr : public hblank_effect_ptr
{

public:
    /**
     * @brief Creates a sprite_affine_mat_pd_register_hblank_effect_ptr which changes the attributes to commit
     ...
     * sprite_affine_mat_pd_register_hblank_effect_ptr to avoid dangling references.
     *
     * @return The requested sprite_affine_mat_pd_register_hblank_effect_ptr.
     */
    [[nodiscard]] static sprite_affine_mat_pd_register_hblank_effect_ptr create(
            sprite_affine_mat_ptr affine_mat, const span<const sprite_affine_mat_attributes>& attributes_ref);

    /**
     * @brief Creates a sprite_affine_mat_pd_register_hblank_effect_ptr which changes the values to commit
     * to the fourth GBA register of a sprite_affine_mat_ptr.
     * @param affine_mat sprite_affine_mat_ptr to be modified.
     ...
     * sprite_affine_mat_pd_register_hblank_effect_ptr to avoid dangling references.
     *
     * @return The requested sprite_affine_mat_pd_register_hblank_effect_ptr if it could be allocated;
     * `nullopt` otherwise.
     */
    [[nodiscard]] static optional<sprite_affine_mat_pd_register_hblank_effect_ptr> create_optional(
            sprite_affine_mat_ptr affine_mat, const span<const sprite_affine_mat_attributes>& attributes_ref);
    ...
    /**
     * @brief Exchanges the contents of this sprite_affine_mat_pd_register_hblank_effect_ptr
     * with those of the other one.
     * @param other sprite_affine_mat_pd_register_hblank_effect_ptr to exchange the contents with.
     */
    void swap(sprite_affine_mat_pd_register_hblank_effect_ptr& other);

    /**
     * @brief Exchanges the contents of a sprite_affine_mat_pd_register_hblank_effect_ptr
     * with those of another one.
     * @param a First sprite_affine_mat_pd_register_hblank_effect_ptr to exchange the contents with.
     * @param b Second sprite_affine_mat_pd_register_hblank_effect_ptr to exchange the contents with.
     */
    friend void swap(sprite_affine_mat_pd_register_hblank_effect_ptr& a,
                     sprite_affine_mat_pd_register_hblank_effect_ptr& b)
    {
        a.swap(b);
    }
...
private:
    ...
    sprite_affine_mat_pd_register_hblank_effect_ptr(int id, bool from_attributes, sprite_affine_mat_ptr&& affine_mat);
};
