...
affine_bg_attributes::affine_bg_attributes(const affine_bg_map_ptr& map, int priority, bool mosaic_enabled) :
    _map(map),
...
affine_bg_attributes::affine_bg_attributes(affine_bg_map_ptr&& map, int priority, bool mosaic_enabled) :
    _map(move(map)),
    _priority(int8_t(priority)),
    _mosaic_enabled(mosaic_enabled)
{
