...
#ifndef BN_AFFINE_BG_ATTRIBUTES_HBLANK_EFFECT_HANDLER_H
#define BN_AFFINE_BG_ATTRIBUTES_HBLANK_EFFECT_HANDLER_H
...
class affine_bg_attributes_hblank_effect_handler
{
