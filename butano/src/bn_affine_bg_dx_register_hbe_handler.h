...
#ifndef BN_AFFINE_BG_DX_REGISTER_HBE_HANDLER_H
#define BN_AFFINE_BG_DX_REGISTER_HBE_HANDLER_H
...
class affine_bg_dx_register_attributes_hbe_handler
{
...
class affine_bg_dx_register_values_hbe_handler
{
...
public:
    ...
    static void write_output_values(intptr_t, const void*, const void* input_values_ptr,
