...
span<const int16_t> affine_bg_dx_register_hblank_effect_ptr::values_ref() const
{
...
void affine_bg_dx_register_hblank_effect_ptr::set_values_ref(const span<const int16_t>& values_ref)
{
    BN_ASSERT(! _from_attributes, "Built from attributes");
