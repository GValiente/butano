        ...
        affine_bg_ptr bg, const span<const affine_bg_mat_attributes>& attributes_ref)
{
    ...
    return affine_bg_dy_register_hblank_effect_ptr(id, true, move(bg));
}
        ...
        affine_bg_ptr bg, const span<const int16_t>& values_ref)
{
    ...
    return affine_bg_dy_register_hblank_effect_ptr(id, false, move(bg));
}
        ...
        affine_bg_ptr bg, const span<const affine_bg_mat_attributes>& attributes_ref)
{
    ...
    if(id >= 0)
    {
        result = affine_bg_dy_register_hblank_effect_ptr(id, true, move(bg));
    }
        ...
        affine_bg_ptr bg, const span<const int16_t>& values_ref)
{
    ...
    if(id >= 0)
    {
        result = affine_bg_dy_register_hblank_effect_ptr(id, false, move(bg));
    }
...
span<const int16_t> affine_bg_dy_register_hblank_effect_ptr::values_ref() const
{
...
void affine_bg_dy_register_hblank_effect_ptr::set_values_ref(const span<const int16_t>& values_ref)
{
    BN_ASSERT(! _from_attributes, "Built from attributes");
