...
#ifndef BN_AFFINE_BG_HORIZONTAL_POSITION_HBLANK_EFFECT_HANDLER_H
#define BN_AFFINE_BG_HORIZONTAL_POSITION_HBLANK_EFFECT_HANDLER_H
...
class affine_bg_horizontal_position_hblank_effect_handler
{
