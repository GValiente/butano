...
#ifndef BN_AFFINE_BG_PA_REGISTER_HBE_HANDLER_H
#define BN_AFFINE_BG_PA_REGISTER_HBE_HANDLER_H
...
class affine_bg_pa_register_attributes_hbe_handler
{
...
class affine_bg_pa_register_values_hbe_handler
{
