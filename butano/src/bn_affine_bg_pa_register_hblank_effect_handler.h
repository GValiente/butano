...
#ifndef BN_AFFINE_BG_PA_REGISTER_HBLANK_EFFECT_HANDLER_H
#define BN_AFFINE_BG_PA_REGISTER_HBLANK_EFFECT_HANDLER_H
...
class affine_bg_pa_register_attributes_hblank_effect_handler
{
...
class affine_bg_pa_register_values_hblank_effect_handler
{
