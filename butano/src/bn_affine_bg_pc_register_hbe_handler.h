...
#ifndef BN_AFFINE_BG_PC_REGISTER_HBE_HANDLER_H
#define BN_AFFINE_BG_PC_REGISTER_HBE_HANDLER_H
...
class affine_bg_pc_register_attributes_hbe_handler
{
...
class affine_bg_pc_register_values_hbe_handler
{
