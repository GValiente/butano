...
#ifndef BN_AFFINE_BG_PC_REGISTER_HBLANK_EFFECT_HANDLER_H
#define BN_AFFINE_BG_PC_REGISTER_HBLANK_EFFECT_HANDLER_H
...
class affine_bg_pc_register_attributes_hblank_effect_handler
{
...
public:
    ...
    [[nodiscard]] static uint16_t* output_register(int target_id)
    {
        ...
        int16_t* result = &hw::bgs::affine_mat_register(hw_id)->pc;
...
class affine_bg_pc_register_values_hblank_effect_handler
{
