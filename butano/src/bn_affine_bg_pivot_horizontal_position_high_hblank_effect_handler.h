...
#ifndef BN_AFFINE_BG_PIVOT_HORIZONTAL_POSITION_HIGH_HBLANK_EFFECT_HANDLER_H
#define BN_AFFINE_BG_PIVOT_HORIZONTAL_POSITION_HIGH_HBLANK_EFFECT_HANDLER_H
...
class affine_bg_pivot_horizontal_position_high_hblank_effect_handler
{
...
public:
                                    ...
                                    uint16_t* output_values_ptr)
    {
        ...
        bgs_manager::fill_hblank_effect_pivot_horizontal_positions(handle, true, fixed_values_ptr, output_values_ptr);
    }
