...
dp_direct_bitmap_bg_attributes_hbe_ptr dp_direct_bitmap_bg_attributes_hbe_ptr::create(
        dp_direct_bitmap_bg_ptr bg, const span<const bitmap_bg_attributes>& attributes_ref)
{
    ...
    return dp_direct_bitmap_bg_attributes_hbe_ptr(id, move(bg));
}

optional<dp_direct_bitmap_bg_attributes_hbe_ptr> dp_direct_bitmap_bg_attributes_hbe_ptr::create_optional(
        dp_direct_bitmap_bg_ptr bg, const span<const bitmap_bg_attributes>& attributes_ref)
{
    ...
    optional<dp_direct_bitmap_bg_attributes_hbe_ptr> result;

    if(id >= 0)
    {
        result = dp_direct_bitmap_bg_attributes_hbe_ptr(id, move(bg));
    }

    return result;
}

span<const bitmap_bg_attributes> dp_direct_bitmap_bg_attributes_hbe_ptr::attributes_ref() const
{
...
void dp_direct_bitmap_bg_attributes_hbe_ptr::reload_attributes_ref()
{
    hblank_effects_manager::reload_values_ref(id());
}

void dp_direct_bitmap_bg_attributes_hbe_ptr::swap(dp_direct_bitmap_bg_attributes_hbe_ptr& other)
{
    hbe_ptr::swap(other);
    _bg.swap(other._bg);
}
