...
namespace bn::hblank_effects_manager
{
    enum class handler_type : uint8_t
    {
        ...
        AFFINE_BG_PIVOT_HORIZONTAL_POSITION_HIGH,
        AFFINE_BG_PIVOT_HORIZONTAL_POSITION_LOW,
        REGULAR_BG_VERTICAL_POSITION,
        AFFINE_BG_PIVOT_VERTICAL_POSITION_HIGH,
        AFFINE_BG_PIVOT_VERTICAL_POSITION_LOW,
        ...
        AFFINE_BG_DX_HIGH_REGISTER_ATTRIBUTES,
        AFFINE_BG_DX_HIGH_REGISTER_VALUES,
        AFFINE_BG_DX_LOW_REGISTER_ATTRIBUTES,
        AFFINE_BG_DX_LOW_REGISTER_VALUES,
        AFFINE_BG_DY_HIGH_REGISTER_ATTRIBUTES,
        AFFINE_BG_DY_HIGH_REGISTER_VALUES,
        AFFINE_BG_DY_LOW_REGISTER_ATTRIBUTES,
        AFFINE_BG_DY_LOW_REGISTER_VALUES,
