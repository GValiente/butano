...
#ifndef BN_REGULAR_BG_VERTICAL_POSITION_HBLANK_EFFECT_HANDLER_H
#define BN_REGULAR_BG_VERTICAL_POSITION_HBLANK_EFFECT_HANDLER_H
...
class regular_bg_vertical_position_hblank_effect_handler
{
...
public:
                                    ...
                                    uint16_t* output_values_ptr)
    {
        ...
        bgs_manager::fill_hblank_effect_regular_vertical_positions(last_value, fixed_values_ptr, output_values_ptr);
    }
