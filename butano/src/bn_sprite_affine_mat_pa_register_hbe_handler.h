...
#ifndef BN_SPRITE_AFFINE_MAT_PA_REGISTER_HBE_HANDLER_H
#define BN_SPRITE_AFFINE_MAT_PA_REGISTER_HBE_HANDLER_H
...
class sprite_affine_mat_pa_register_attributes_hbe_handler
{
...
class sprite_affine_mat_pa_register_values_hbe_handler
{
