...
#ifndef BN_SPRITE_AFFINE_MAT_PB_REGISTER_HBE_HANDLER_H
...
class sprite_affine_mat_pb_register_attributes_hbe_handler
{
...
class sprite_affine_mat_pb_register_values_hbe_handler
{
