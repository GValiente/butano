...
#ifndef BTN_SPRITE_AFFINE_MAT_PB_REGISTER_HBLANK_EFFECT_HANDLER_H
#define BTN_SPRITE_AFFINE_MAT_PB_REGISTER_HBLANK_EFFECT_HANDLER_H
...
class sprite_affine_mat_pb_register_attributes_hblank_effect_handler
{
...
class sprite_affine_mat_pb_register_values_hblank_effect_handler
{
