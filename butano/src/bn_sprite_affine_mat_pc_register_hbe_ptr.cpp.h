...
sprite_affine_mat_pc_register_hbe_ptr sprite_affine_mat_pc_register_hbe_ptr::create(
        sprite_affine_mat_ptr affine_mat, const span<const affine_mat_attributes>& attributes_ref)
{
    int id = hblank_effects_manager::create(attributes_ref.data(), attributes_ref.size(), affine_mat.id(),
                                            hblank_effects_manager::handler_type::SPRITE_AFFINE_MAT_PC_REGISTER_ATTRIBUTES);
    return sprite_affine_mat_pc_register_hbe_ptr(id, true, move(affine_mat));
}
        ...
        sprite_affine_mat_ptr affine_mat, const span<const int16_t>& values_ref)
{
    int id = hblank_effects_manager::create(values_ref.data(), values_ref.size(), affine_mat.id(),
                                            hblank_effects_manager::handler_type::SPRITE_AFFINE_MAT_PC_REGISTER_VALUES);
    return sprite_affine_mat_pc_register_hbe_ptr(id, false, move(affine_mat));
}

optional<sprite_affine_mat_pc_register_hbe_ptr> sprite_affine_mat_pc_register_hbe_ptr::create_optional(
        sprite_affine_mat_ptr affine_mat, const span<const affine_mat_attributes>& attributes_ref)
{
    int id = hblank_effects_manager::create_optional(attributes_ref.data(), attributes_ref.size(), affine_mat.id(),
                                                     hblank_effects_manager::handler_type::SPRITE_AFFINE_MAT_PC_REGISTER_ATTRIBUTES);
    optional<sprite_affine_mat_pc_register_hbe_ptr> result;

    if(id >= 0)
    {
        result = sprite_affine_mat_pc_register_hbe_ptr(id, true, move(affine_mat));
    }
        ...
        sprite_affine_mat_ptr affine_mat, const span<const int16_t>& values_ref)
{
    ...
    if(id >= 0)
    {
        result = sprite_affine_mat_pc_register_hbe_ptr(id, false, move(affine_mat));
    }

    return result;
}

span<const affine_mat_attributes> sprite_affine_mat_pc_register_hbe_ptr::attributes_ref() const
{
...
span<const int16_t> sprite_affine_mat_pc_register_hbe_ptr::values_ref() const
{
...
void sprite_affine_mat_pc_register_hbe_ptr::set_attributes_ref(
...
void sprite_affine_mat_pc_register_hbe_ptr::set_values_ref(
...
void sprite_affine_mat_pc_register_hbe_ptr::reload_attributes_ref()
{
    hblank_effects_manager::reload_values_ref(id());
}

void sprite_affine_mat_pc_register_hbe_ptr::reload_values_ref()
{
    hblank_effects_manager::reload_values_ref(id());
}

void sprite_affine_mat_pc_register_hbe_ptr::swap(sprite_affine_mat_pc_register_hbe_ptr& other)
{
    hbe_ptr::swap(other);
...
sprite_affine_mat_pc_register_hbe_ptr::sprite_affine_mat_pc_register_hbe_ptr(
