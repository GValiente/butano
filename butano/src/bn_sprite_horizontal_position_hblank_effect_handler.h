...
#ifndef BTN_SPRITE_HORIZONTAL_POSITION_HBLANK_EFFECT_HANDLER_H
#define BTN_SPRITE_HORIZONTAL_POSITION_HBLANK_EFFECT_HANDLER_H
...
class sprite_horizontal_position_hblank_effect_handler
{
