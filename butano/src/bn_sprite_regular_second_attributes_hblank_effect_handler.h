...
#ifndef BTN_SPRITE_REGULAR_SECOND_ATTRIBUTES_HBLANK_EFFECT_HANDLER_H
#define BTN_SPRITE_REGULAR_SECOND_ATTRIBUTES_HBLANK_EFFECT_HANDLER_H
...
class sprite_regular_second_attributes_hblank_effect_handler
{
...
public:
    ...
    {
        BTN_ASSERT(! sprites_manager::affine_mat(reinterpret_cast<void*>(target_id)), "Sprite is not regular");
