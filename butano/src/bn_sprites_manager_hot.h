...
inline void check_items_on_screen(intrusive_list<sorted_sprites::layer>& layers)
{
...
[[nodiscard]] inline int rebuild_handles(
...
[[nodiscard]] inline bool update_cameras(intrusive_list<sorted_sprites::layer>& layers)
{
