...
void set_horizontal_stretch(fixed horizontal_stretch)
{
    ...
    display_manager::set_sprites_mosaic_horizontal_stretch(horizontal_stretch);
}
...
void set_vertical_stretch(fixed vertical_stretch)
{
    ...
    display_manager::set_sprites_mosaic_vertical_stretch(vertical_stretch);
}
...
void set_stretch(fixed stretch)
{
    ...
    display_manager::set_sprites_mosaic_stretch(stretch);
}
...
void set_stretch(fixed horizontal_stretch, fixed vertical_stretch)
{
    ...
    display_manager::set_sprites_mosaic_stretch(horizontal_stretch, vertical_stretch);
}
