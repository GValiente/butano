...
#ifndef BTN_RECT_WINDOW_VERTICAL_BOUNDARIES_HBLANK_EFFECT_HANDLER_H
#define BTN_RECT_WINDOW_VERTICAL_BOUNDARIES_HBLANK_EFFECT_HANDLER_H
...
class rect_window_vertical_boundaries_hblank_effect_handler
{
