...
namespace
{
    ...
    public:
                                 ...
                                 const void* input_values_ptr, uint16_t* output_values_ptr) final
        {
            ...
            auto sprite_second_attributes_ptr = reinterpret_cast<const sprite_second_attributes*>(input_values_ptr);
            sprites_manager::fill_hblank_effect_second_attributes(
                        last_value.hw_x, last_value.size, sprite_second_attributes_ptr, output_values_ptr);
        }
...
sprite_second_attributes_hblank_effect_ptr sprite_second_attributes_hblank_effect_ptr::create(
        sprite_ptr sprite_ptr, const span<const sprite_second_attributes>& attributes_ref)
{
    int id = hblank_effects_manager::create(attributes_ref.data(), attributes_ref.size(),
                                            int(sprite_ptr.handle()), data.second_attributes_handler);
    return sprite_second_attributes_hblank_effect_ptr(id, move(sprite_ptr));
}

optional<sprite_second_attributes_hblank_effect_ptr> sprite_second_attributes_hblank_effect_ptr::optional_create(
        sprite_ptr sprite_ptr, const span<const sprite_second_attributes>& attributes_ref)
{
    int id = hblank_effects_manager::optional_create(attributes_ref.data(), attributes_ref.size(),
                                                     int(sprite_ptr.handle()), data.second_attributes_handler);
    optional<sprite_second_attributes_hblank_effect_ptr> result;

    if(id >= 0)
    {
        result = sprite_second_attributes_hblank_effect_ptr(id, move(sprite_ptr));
    }

    return result;
}

sprite_second_attributes_hblank_effect_ptr::sprite_second_attributes_hblank_effect_ptr(
        const sprite_second_attributes_hblank_effect_ptr& other) :
    hblank_effect_ptr(other),
    _sprite_ptr(other._sprite_ptr)
{
}

sprite_second_attributes_hblank_effect_ptr& sprite_second_attributes_hblank_effect_ptr::operator=(
        const sprite_second_attributes_hblank_effect_ptr& other)
{
...
sprite_second_attributes_hblank_effect_ptr::sprite_second_attributes_hblank_effect_ptr(
        sprite_second_attributes_hblank_effect_ptr&& other) :
...
span<const sprite_second_attributes> sprite_second_attributes_hblank_effect_ptr::attributes_ref() const
{
    auto values_ptr = reinterpret_cast<const sprite_second_attributes*>(hblank_effects_manager::values_ref(id()));
    return span<const sprite_second_attributes>(values_ptr, hblank_effects_manager::values_count(id()));
}

void sprite_second_attributes_hblank_effect_ptr::set_attributes_ref(
        const span<const sprite_second_attributes>& attributes_ref)
{
    hblank_effects_manager::set_values_ref(id(), attributes_ref.data(), attributes_ref.size());
}

void sprite_second_attributes_hblank_effect_ptr::reload_attributes_ref()
{
    hblank_effects_manager::reload_values_ref(id());
}

void sprite_second_attributes_hblank_effect_ptr::swap(sprite_second_attributes_hblank_effect_ptr& other)
{
    hblank_effect_ptr::swap(other);
    btn::swap(_sprite_ptr, other._sprite_ptr);
}

sprite_second_attributes_hblank_effect_ptr::sprite_second_attributes_hblank_effect_ptr(int id, sprite_ptr&& sprite_ptr) :
