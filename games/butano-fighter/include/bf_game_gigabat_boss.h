...
public:
    gigabat_boss(const bn::fixed_point& hero_position, const bn::sprite_palette_ptr& damage_palette,
...
private:
    bn::vector<bn::fixed_rect, 1> _gigabat_rects;
    bn::vector<bn::sprite_ptr, 4> _sprites;
    bn::optional<bn::sprite_ptr> _shadow_sprite;
    bn::vector<bn::sprite_animate_action<5>, 2> _animate_actions;
    bn::fixed_point _gigabat_position;
    ...
    void _shoot_target_random_bullet(const bn::fixed_point& hero_position, const bn::camera_ptr& camera,
                                     enemy_bullets& enemy_bullets);

    void _shoot_free_random_bullet(const bn::fixed_point& hero_position, const bn::camera_ptr& camera,
                                   enemy_bullets& enemy_bullets);

    void _update_sprites(const bn::fixed_point& hero_position, bool hide_shadow);
