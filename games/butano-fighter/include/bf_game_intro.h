...
private:
    ...
    bn::vector<bn::sprite_third_attributes, bn::display::height()> _background_sprite_hblank_effect_attributes_1;
    bn::vector<bn::sprite_third_attributes, bn::display::height()> _background_sprite_hblank_effect_attributes_2;
    bn::vector<bn::sprite_third_attributes_hblank_effect_ptr, 2> _background_sprite_hblank_effects;
