...
namespace
{
    ...
    constexpr const hero_bullet_level _levels[] = {
        ...
        hero_bullet_level(_level2_events,   btn::fixed_size(13, 14),    btn::sound_items::gun_1,            900,
                btn::color(13, 2, 2),   80,     4),
        hero_bullet_level(_level3_events,   btn::fixed_size(11, 15),    btn::sound_items::gun_3,            1500,
