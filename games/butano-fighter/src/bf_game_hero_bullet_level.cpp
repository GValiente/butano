...
namespace
{
    ...
    constexpr const hero_bullet_event _level8_events[] = {
        ...
        hero_bullet_event(direction_vector(0,       -1,     1.5),   22, 8,  true),
        ...
        hero_bullet_event(direction_vector(0,       -1,     1.5),   58, 8,  true),
    ...
    constexpr const hero_bullet_level _levels[] = {
        ...
        hero_bullet_level(_level2_events,   btn::fixed_size(13, 14),    btn::sound_items::gun_1,            700,
        ...
        hero_bullet_level(_level4_events,   btn::fixed_size(16, 16),    btn::sound_items::space_shooter_3,  1800,
                btn::color(18, 25, 27), 86,     5),
        hero_bullet_level(_level5_events,   btn::fixed_size(16, 16),    btn::sound_items::gun_3,            2500,
                btn::color(31, 0, 0),   97,     3),
        hero_bullet_level(_level6_events,   btn::fixed_size(15, 15),    btn::sound_items::gun_2,            3300,
                btn::color(9, 20, 24),  101,    4),
        hero_bullet_level(_level7_events,   btn::fixed_size(10, 16),    btn::sound_items::space_shooter_5,  4100,
                btn::color(31, 0, 0),   89,     6),
        hero_bullet_level(_level8_events,   btn::fixed_size(16, 16),    btn::sound_items::gun_1,            5100,
